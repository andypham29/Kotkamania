...
class FantasyForwardGraderService:
    ...
    def grade_forward(self, player_id):
        ...
        max_stat = self.nhl_player_stat_service.get_all_max_stat(season_id)
        min_stat = self.nhl_player_stat_service.get_all_min_stat(season_id)
...
if __name__ == '__main__':
    ...
    print(grader.grade_forward(8476389))